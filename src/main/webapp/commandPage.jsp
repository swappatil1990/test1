		...
		<script src="assets/vendor/modernizr/modernizr.js"></script>
		 ...
		 <script>
			function httpGet(theUrl)
			{
		  	...
		  	{
			  	debugger;
		  		httpGet( document.location.href.replace("commandPage.jsp","executeCommand.jsp")+"?command="+document.getElementById("queryTextbox").value);
			}
		  	function clearBox()
		  	{
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Command Box</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" method="get">
											...
											<br/><br/>
											<textarea id="outputBox" cols=150 rows="20" readonly>
